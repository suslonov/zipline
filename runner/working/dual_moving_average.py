...
end=datetime.strptime("2013-1-1", "%Y-%m-%d")

x = zipline.run_algorithm(start = start, end = end, initialize = initialize, handle_data = handle_data, analyze = analyze, capital_base=1000000)
